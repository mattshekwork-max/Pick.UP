        ...
        {provisionedPhone ? (
          ...
          <Card className="border-[#0D9488]/20 bg-[#0D9488]/5">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 bg-[#0D9488]/10 dark:bg-[#0D9488]/20 border border-[#0D9488]/30 rounded-xl">
                <h3 className="font-semibold text-[#0D9488] dark:text-[#14b8a6] mb-3 flex items-center gap-2">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white mb-2">Quick Setup (Most Carriers):</h4>
                    <ol className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                      <li className="flex items-start gap-2">
                        <span className="font-bold bg-[#0D9488]/20 dark:bg-[#0D9488]/30 text-[#0D9488] dark:text-[#14b8a6] px-2 py-0.5 rounded">1</span>
                        <span>Pick up your current phone (the one you want to forward)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="font-bold bg-[#0D9488]/20 dark:bg-[#0D9488]/30 text-[#0D9488] dark:text-[#14b8a6] px-2 py-0.5 rounded">2</span>
                        <span>Dial: <code className="bg-[#0D9488]/10 dark:bg-[#0D9488]/20 px-2 py-0.5 rounded">*72</code> (most US carriers)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="font-bold bg-[#0D9488]/20 dark:bg-[#0D9488]/30 text-[#0D9488] dark:text-[#14b8a6] px-2 py-0.5 rounded">3</span>
                        <span>When you hear a tone or dial tone, enter your Pick.UP number: <strong className="text-[#0D9488] dark:text-[#14b8a6]">{provisionedPhone}</strong></span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="font-bold bg-[#0D9488]/20 dark:bg-[#0D9488]/30 text-[#0D9488] dark:text-[#14b8a6] px-2 py-0.5 rounded">4</span>
                        <span>Wait for confirmation (usually 2 beeps or a voice message)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="font-bold bg-[#0D9488]/20 dark:bg-[#0D9488]/30 text-[#0D9488] dark:text-[#14b8a6] px-2 py-0.5 rounded">5</span>
                        <span>Test it! Call your old number from another phone - it should ring on Pick.UP</span>
                      </li>
                    </ol>
                  </div>

                  <div className="border-t border-[#0D9488]/20 dark:border-[#0D9488]/30 pt-4">
                    <h4 className="font-bold text-gray-900 dark:text-white mb-2">Carrier-Specific Codes:</h4>
                    <div className="grid grid-cols-2 gap-2 text-xs text-gray-700 dark:text-gray-300">
                      <div className="bg-[#0D9488]/10 dark:bg-[#0D9488]/20 p-2 rounded">
                  ...
                  <div className="border-t border-[#0D9488]/20 dark:border-[#0D9488]/30 pt-4">
                    <h4 className="font-bold text-gray-900 dark:text-white mb-2">📞 Landline Users</h4>
                    ...
                    <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Lift the receiver and dial <code className="bg-[#0D9488]/10 dark:bg-[#0D9488]/20 px-1.5 py-0.5 rounded">*72</code></span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="font-bold">•</span>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400 mt-3 italic">
                      <strong>Tip:</strong> Some landline providers allow you to change the ring count before forwarding kicks in. Try dialing <code className="bg-[#0D9488]/10 dark:bg-[#0D9488]/20 px-1.5 py-0.5 rounded">*47</code> followed by a code (e.g., dial 30 for 5 rings). Check with your provider for exact codes.
                    </p>
                  </div>

                  <div className="border-t border-[#0D9488]/20 dark:border-[#0D9488]/30 pt-4">
                    <h4 className="font-bold text-gray-900 dark:text-white mb-2">Alternative: Carrier App/Website</h4>
                    <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
